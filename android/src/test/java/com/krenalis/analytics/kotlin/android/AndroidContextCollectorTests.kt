...
import com.krenalis.analytics.kotlin.android.plugins.AndroidContextPlugin
import com.krenalis.analytics.kotlin.android.plugins.getUniqueID
import com.krenalis.analytics.kotlin.android.utils.MemorySharedPreferences
import com.krenalis.analytics.kotlin.android.utils.testAnalytics
...
class AndroidContextCollectorTests {
    ...
    fun setUp() {
        ...
        mockkStatic("com.krenalis.analytics.kotlin.android.plugins.AndroidContextPluginKt")
    ...
    fun `context fields applied correctly`()  {
        ...
        with(event.context) {
            ...
            this["app"]?.jsonObject?.let {
                assertEquals("com.krenalis.analytics.test", it["name"].asString())
                assertEquals("undefined", it["version"].asString())
                assertEquals("com.krenalis.analytics.test", it["namespace"].asString())
