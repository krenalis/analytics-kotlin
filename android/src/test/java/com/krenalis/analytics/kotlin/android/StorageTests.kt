package com.krenalis.analytics.kotlin.android

import android.content.Context
import android.content.SharedPreferences
import com.krenalis.analytics.kotlin.android.utils.MemorySharedPreferences
import com.krenalis.analytics.kotlin.android.utils.clearPersistentStorage
import com.krenalis.analytics.kotlin.android.utils.mockContext
import com.krenalis.analytics.kotlin.core.Configuration
import com.krenalis.analytics.kotlin.core.Settings
import com.krenalis.analytics.kotlin.core.Storage
import com.krenalis.analytics.kotlin.core.System
import com.krenalis.analytics.kotlin.core.TrackEvent
import com.krenalis.analytics.kotlin.core.UserInfo
    ...
    inner class Android {
        ...
        inner class KeyValueStorage {
            ...
            fun `write updates sharedPreferences`() = runTest {
                ...
                assertEquals("100", map["krenalis.app.version"])
            }

            @Test
            fun `read fetches from sharedPreferences`() {
                map["krenalis.app.version"] = "100"
            ...
            fun `remove sets value to null`() {
                ...
                assertEquals(null, map["krenalis.app.version"])
            }
        }
