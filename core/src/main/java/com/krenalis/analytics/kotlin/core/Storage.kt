 ...
 *
 * Constraints:
 * - Krenalis Events must be stored on a file, following the batch format
...
interface Storage {
    ...
    enum class Constants(val rawVal: String) {
        UserId("krenalis.userId"),
        Traits("krenalis.traits"),
        AnonymousId("krenalis.anonymousId"),
        Settings("krenalis.settings"),
        Events("krenalis.events"),
        AppVersion("krenalis.app.version"),
        AppBuild("krenalis.app.build"),
        LegacyAppBuild("build"),
        DeviceId("krenalis.device.id"),
        SessionId("krenalis.sessionId"),
        SessionExpiration("krenalis.sessionExpiration"),
        SessionStart("krenalis.sessionStart"),
        Suspended("krenalis.suspended"),
    }
