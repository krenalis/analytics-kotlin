...
import com.krenalis.analytics.kotlin.core.Constants.DEFAULT_ENDPOINT
 ...
 * @property writeKey the Krenalis writeKey
 ...
 * @property autoAddKrenalisDestination automatically add KrenalisDestination plugin, defaults to `true`
 * @property autoAddSegmentDestination same as autoAddKrenalisDestination. defaults to `true`. This remains for compatibility with Segment SDK.
 * @property endpoint set the base endpoint used to construct the event dispatch and settings retrieval endpoints. Defaults to `test.example.com/v1`.
...
data class Configuration(
    ...
    var autoAddKrenalisDestination: Boolean = true,
