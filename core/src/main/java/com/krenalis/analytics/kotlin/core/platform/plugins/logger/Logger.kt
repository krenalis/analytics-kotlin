...
interface Logger {
     ...
     * - important: Use the Krenalis Network stack for Krenalis library compatibility and simplicity.
     */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 * The public logging method for capturing all general types of log messages related to krenalis.
 *
...
fun Analytics.log(message: String, kind: LogKind = LogKind.DEBUG) {
    Analytics.krenalisLog(message, kind)
}
