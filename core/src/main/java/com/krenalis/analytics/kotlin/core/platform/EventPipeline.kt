package com.krenalis.analytics.kotlin.core.platform

import com.krenalis.analytics.kotlin.core.*
import com.krenalis.analytics.kotlin.core.platform.plugins.logger.LogKind
import com.krenalis.analytics.kotlin.core.platform.plugins.logger.log
import com.krenalis.analytics.kotlin.core.platform.plugins.logger.krenalisLog
    ...
    private fun write() = scope.launch(fileIODispatcher) {
        for (event in writeChannel) {
            ...
            if (!isPoison) try {
                ...
                Analytics.krenalisLog("Error adding payload: $event", kind = LogKind.ERROR)
            }
