...
import com.krenalis.analytics.kotlin.core.platform.EnrichmentClosure
import com.krenalis.analytics.kotlin.core.platform.EventPlugin
import com.krenalis.analytics.kotlin.core.platform.Plugin
import com.krenalis.analytics.kotlin.core.platform.Timeline
...
import com.krenalis.analytics.kotlin.core.platform.plugins.StartupQueue
import com.krenalis.analytics.kotlin.core.platform.plugins.UserInfoPlugin
import com.krenalis.analytics.kotlin.core.platform.plugins.logger.*
import com.krenalis.analytics.kotlin.core.utilities.JsonAnySerializer
...
open class Analytics protected constructor(
    ...
    internal fun build() {
        ...
        analyticsScope.launch(analyticsDispatcher) {
            ...
            if (configuration.autoAddKrenalisDestination && configuration.autoAddSegmentDestination) {
                add(KrenalisDestination())
            }
...
internal fun isAndroid(): Boolean {
    return try {
        Class.forName("com.krenalis.analytics.kotlin.android.AndroidStorage")
        true
