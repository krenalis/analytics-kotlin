...
import com.krenalis.analytics.kotlin.core.RequestFactory
...
class ConfigurationBuilder (writeKey: String) {
    ...
    fun setAutoAddKrenalisDestination(autoAddKrenalisDestination: Boolean) = apply { configuration.autoAddKrenalisDestination = autoAddKrenalisDestination}
