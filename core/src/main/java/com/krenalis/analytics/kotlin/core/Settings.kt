...
import com.krenalis.analytics.kotlin.core.utilities.LenientJson
...
/**
 * Manually enable a destination plugin.  This is useful when a given DestinationPlugin doesn't have any Krenalis tie-ins at all.
...
/**
 * Make analytics client call into Krenalis's settings API, to refresh certain configurations.
 */
