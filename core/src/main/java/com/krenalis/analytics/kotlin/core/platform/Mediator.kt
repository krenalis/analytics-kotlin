...
import com.krenalis.analytics.kotlin.core.reportErrorWithMetrics
import com.krenalis.analytics.kotlin.core.reportInternalError
        ...
        plugins.forEach { plugin ->
            result?.let {event ->
                ...
                try {
                    ...
                    Analytics.krenalisLog("Skipping plugin due to Exception: $plugin", kind = LogKind.WARNING)
