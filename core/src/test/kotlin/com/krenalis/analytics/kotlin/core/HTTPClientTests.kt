...
import com.krenalis.analytics.kotlin.core.Constants.LIBRARY_VERSION
import com.krenalis.analytics.kotlin.core.utilities.OkHttpURLConnection
...
class HTTPClientTests {
    ...
    @Disabled
    @Test
    fun `krenalis endpoints support HTTP2`() {
        // Test that our actual Krenalis endpoints use HTTP/2
        ...
        try {
            ...
            if (protocol == "h2") {
                println("✓ Successfully using HTTP/2 for Krenalis settings endpoint")
            } else {
                println("⚠ Fallback to HTTP/1.1 for Krenalis settings endpoint")
            }
        } catch (e: Exception) {
