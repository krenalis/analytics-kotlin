...
internal class ConfigurationBuilderTest {
    ...
    @Test
    fun setAutoAddKrenalisDestination() {
        val expected = false
        val config = builder.setAutoAddKrenalisDestination(expected).build()

        assertEquals(expected, config.autoAddKrenalisDestination)
    }
    ...
    fun build() {
        ...
        val config = builder.setApplication(expected.application)
            ...
            .setAutoAddKrenalisDestination(expected.autoAddKrenalisDestination)
